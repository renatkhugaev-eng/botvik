...
{ quest_kolka_warning:
    ...
    • Нужно: серебро, огонь, верующий спутник
}
...
Пятнадцать дней расследования. Сегодня — финал. # style:title # intensity:high

День полнолуния. # style:title # intensity:high

Всё, что вы узнали. Все, кого встретили. Каждая улика, каждый союзник — сегодня это решает всё. # style:dramatic # intensity:high

Вы встаёте. Умываетесь. Одеваетесь. # style:action

Проверяете оружие. Патроны. Документы. Всё собранное за эти долгие дни. # style:action # intensity:medium

В зеркале — лицо. Чужое. Знакомое. Изменившееся за две недели. # style:atmosphere # intensity:high

Лицо человека, готового завершить начатое. # style:dramatic # intensity:high

Или погибнуть, пытаясь. # style:dramatic # intensity:high
