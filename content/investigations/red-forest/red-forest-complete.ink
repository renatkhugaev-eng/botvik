...
За окном — серое небо, колючая проволока, вышка с прожектором. Закрытый город. Один из сотен безымянных точек на карте СССР.
...
В папке на коленях — докладная записка: "Красногорск-12. За последние два года — семь пропавших без вести. Местная милиция бездействует. Требуется проверка."
...
На КПП двое солдат в тулупах. Один тянется к вашим документам.
...
Люди на улицах отводят взгляд. Слишком тихо. Слишком много пустых окон.
...
Майор Громов — грузный мужчина лет пятидесяти пяти. Седые усы, красное лицо, мутноватый взгляд. На столе — початая бутылка "Столичной".
...
Он наливает водку в два стакана.
...
Он достаёт тонкую папку. Слишком тонкую.

— Инженер Зорин Алексей Павлович. Пропал двадцать третьего октября. Вышел с работы — и всё.

— Тело?

— Не нашли. Тайга. Медведи. Сами понимаете.
...
* [Спросить о других пропавших]
    — Зорин — не первый. Семь человек за два года.
    
    Громов замирает.
    
    — Откуда такие сведения?
    
    — Из докладной записки. Потому меня и прислали.
...
— Ничего. Просто... не копайте слишком глубоко.

* [Это угроза?]
    — Вы мне угрожаете, товарищ майор?
    
    — Боже упаси. Дружеский совет.
...
— Не могу. — Он качает головой. — Но...

Громов оглядывается на дверь. Понижает голос:

— Поговорите со священником. Отец Серафим. При старой церкви, на окраине. Он кое-что знает.

~ CluesD += serafim_legends
~ evidence_collected = evidence_collected + 1

# clue
Улика найдена: совет Громова
...
— Гостиница "Урал", номер двенадцать — забронирован для вас.
...
// Всегда есть шанс увидеть тень — это атмосфера города
На мгновение — вам кажется, что из переулка кто-то смотрит.

Тень? Человеческий силуэт?
...
Гостиница "Урал" — трёхэтажное здание сталинской постройки.

За стойкой — женщина лет шестидесяти. Химическая завивка, любопытные глаза.

— Ой, а вы тот самый следователь?

— Сорокин, Виктор Андреевич.

— А я Клавдия Петровна. Вы у нас надолго?

— Как пойдёт расследование.

— Ой, это вы про Зорина? Бедный Алексей Палыч... И дочка у него — красавица. Таня. Она спрашивала про вас.

* [Где её найти?]
    — Адрес знаете?
    
    — Улица Ленина, семь. Но лучше на завод — она там допоздна.
...
* [Что она хотела?]
    ...
    — Приедет ли следователь. Настоящий, говорит, не местный. Она уверена, что отца убили.
    
    -> ep1_klava_gossip

=== ep1_klava_gossip ===

Клава оглядывается. Шепчет:

— Тут странные дела творятся. Люди пропадают. А милиция — ничего.

— Какие люди?

— Ну, Зорин — последний. А до него — Петрова из больницы. И студент с завода...

Она осекается.

— Ой, что это я разболталась.

* [Настоять]
    — Это важно, Клавдия Петровна.
    
    — Не здесь. Завтра. В ресторане, в обед.
...
За окном — чернота. И где-то — еле слышно — словно поёт хор.
...
Вы раскладываете содержимое папки.

Десять страниц.

**Протокол осмотра** — пусто. Зорин вышел с завода в 18:42. Домой не дошёл.

**Опрос свидетелей** — двое видели его на улице.

**Заключение** — "предположительно несчастный случай".

* [Искать нестыковки]
    Два свидетеля видели Зорина в одно время — 18:50. Но в РАЗНЫХ местах.
    
    Иванов — на улице Ленина.
    Кузнецова — у гастронома на площади.
    
    Расстояние — минимум пятнадцать минут ходьбы.
...
За окном — полная темнота. Одиннадцать часов.
...
Город ночью — другой. Пустой, настороженный.

* [К заводу]
    Вы идёте к заводским трубам.
    
    У забора — что-то странное.
    
    Символ. Красный круг, три линии к центру. Краска свежая.
...
* [К окраине]
    Вы идёте прочь от центра.
    
    Дома становятся ниже. Частный сектор.
...
Мужчина. Невысокий, в телогрейке. Лицо в тени.

— Уходите. Пока можете.

— Вы кто?

— Фёдор. Сторож. Бывший. — Он отступает в темноту. — Они видят. Всегда видят. Красный лес... он зовёт...

И исчезает.

~ lose_sanity(5)
~ KeyEvents += heard_voices
// Фёдор предупредил — можно искать его в эпизоде 2
~ KeyEvents += fyodor_warned

* [Вернуться в гостиницу]
    Сердце колотится.
    
    Кто такой Фёдор? Сторожка на краю леса... Нужно найти его.
    
    -> ep1_sleep

=== ep1_forest_edge ===

Лес начинается резко. Сосны высокие, чёрные.

И — запах. Сладковатый, тяжёлый.

* [Подойти ближе]
    Темнота леса — абсолютная.
    
    Движение между стволами. Белое пятно. Лицо?
...
Спиной ощущаете... взгляд?

{ sanity < 70:
    Вы не оглядываетесь. Всю дорогу.
}
...
{ KeyEvents ? saw_symbol:
    Красный символ. Три линии к центру.
    
    Вы где-то его видели. Давно.
}
...
{ is_mad():
    ОНО смотрит на вас. Из центра круга.
...
День первый расследования (утро)

Вы просыпаетесь от стука.

— Товарищ Сорокин! Завтрак!
...
Холодная вода приводит в чувство.

В блокноте — план:
1. Допросить свидетелей
2. Поговорить с Таней Зориной
3. Найти отца Серафима
...
{ KeyEvents ? heard_voices:
    Красный лес. Фигуры в капюшонах. Ваше собственное лицо.
    
    Вы просыпаетесь в три часа ночи. Не можете уснуть до рассвета.
    
    ~ lose_sanity(2)
}

{ KeyEvents ? saw_symbol:
    Символ. Красный круг, три линии. Он горит перед глазами даже когда вы их закрываете.
}

За окном — серый рассвет. Снег.
...
Ресторан "Урал". Обеденное время.

Клавдия Петровна сидит в углу. Оглядывается.

— Садитесь, садитесь. Быстрее.

Вы заказываете борщ. Она — ничего.

— Я не должна это рассказывать...

* [Подождать]
    Вы молчите. Она нервно теребит салфетку.
...
* [Это важно для расследования]
    — Клавдия Петровна, речь идёт о жизни и смерти.
...
— Мой муж работал на заводе. Двадцать лет назад.

— Работал?

— Умер. Официально — сердце. Но...

Она понижает голос до шёпота:

— Он видел ТО ЖЕ САМОЕ. Красный лес. Голоса. За неделю до смерти начал рисовать символы на стенах.

~ cult_awareness = cult_awareness + 2

— Какие символы?

— Круг. Три линии к центру.
...
* [Где эти рисунки сейчас?]
    ...
    — Но... — Она достаёт из сумки фотографию. — Это осталось.
    
    На фото — стена, покрытая символами. В центре — силуэт человека.
...
* [Кто ещё знает об этом?]
    — Никто. Только... был один человек. Фёдор. Сторож.
    
    — Он тоже видел?
    
    — Он единственный, кто ВЫЖИЛ. После того как побывал ТАМ.
...
Больница №1. Психиатрическое отделение.

Вас встречает запах хлорки и тишина.
...
{ not (MetCharacters ? vera):
    ...
    Женщина в белом халате поворачивается. Лет сорока. Усталые глаза за очками.
    
    — Следователь Сорокин? Меня предупредили.
    
    ~ trust_vera = trust_vera + 5
}

— Мне нужна информация о пациентах с... необычными симптомами.

Вера оглядывается. Закрывает дверь кабинета.
...
Окраина города. Лес начинается сразу за последним домом.

Сторожка — покосившаяся избушка. Дым из трубы.

Вы стучите.

Долго ничего. Потом — шорох.
...
Дверь приоткрывается. Фёдор. Тот самый. Глаза — дикие, но ясные.
...
* [Поговорить на пороге]
    ...
    — Как хотите. Но ОНИ видят. Везде.
    
    -> ep2_fyodor_talk

=== ep2_fyodor_inside ===

Внутри — хаос. Стены покрыты символами. Картами. Газетными вырезками.

— Вы... коллекционируете?

— Я ПОМНЮ. Двадцать лет помню. Каждую ночь.
...
* [Сначала — кто вы?]
    — Я был геологом. Как Серафим. Мы нашли пещеры в пятьдесят третьем. Вместе.
...
— В пятьдесят третьем мы нашли пещеры под тем местом, где теперь завод. А в пещерах — рисунки. Тысячи лет.

— И?

— Учёные приехали. Из Москвы. Начали эксперименты. "Проект Эхо".

Он достаёт мятую карту.

— Вот. Подземелья. Я чертил по памяти.
...
— Центр — там. — Он указывает точку. — Алтарь. Они называют это Дверью.

* [Дверь куда?]
    — Не "куда". "Откуда". ОНО приходит оттуда. Когда открывают.
...
* [Кто "они"?]
    — Чернов. Главный. И его... последователи. Они верят, что ОНО — бог. Что оно даст им силу.
...
{ days_remaining <= 3:
    Осталось мало времени. Ритуал приближается.
}

{ sanity < 50:
    Вы просыпаетесь в холодном поту.
    
    Голоса не давали спать.
...
{ KeyEvents ? fyodor_ally:
    Фёдор. Он обещал провести вас в ночь полнолуния. Через два дня.
    
    Но сначала — завод. Нужно найти вход в пещеры.
}

// Серафим может помочь, если доверяет
{ trust_serafim >= 50 && MetCharacters ? serafim:
    Серафим говорил о тайных ходах в пещеры. Можно попросить его о помощи.
}
...
{ not (KeyEvents ? entered_caves):
    ...
    За ржавой дверью — лестница вниз.
    
    Вы находите вход в пещеры под заводом.
    
    Древние. С рисунками на стенах.
...
Вы идёте вглубь. Один. Темнота густеет.
...
{ is_sane():
    Вы спите. Спокойно, несмотря ни на что.
...
{ is_disturbed():
    Сон прерывистый. Кошмары.
    
    Красный лес. Алтарь. Жертвы.
...
{ is_mad():
    ...
    Грань между сном и явью — стёрта.
...
Лес. Тот самый. Красный лес.

{ Relationships ? romantic_tanya:
    Таня рядом. Решительная.
}

Вход в пещеры. Темнота.

И — красный свет. Впереди.
...
{ trust_astahov < -5:
    Вы замечаете Астахова. Он смотрит в вашу сторону. Ждёт.
...
На алтаре — связанные фигуры.

// Описание жертв зависит от того, кого игрок встретил
{ MetCharacters ? serafim && MetCharacters ? vera:
    Серафим. Вера. И... Зорин?
- else:
    { MetCharacters ? serafim:
        Серафим. Какая-то женщина в белом халате. И... Зорин?
    - else:
        { MetCharacters ? vera:
            Старик в рясе. Вера. И... Зорин?
        - else:
            Старик в рясе. Женщина в белом халате. И мужчина — Зорин?
        }
    }
}
...
Культ разгромлен. Пещеры засыпаны.
...
Вас отстраняют. Ваши показания — "бред больного".

Культ уничтожен. Но правда похоронена.

Иногда ночью вы слышите голоса.

«...мы ждём... Дверь закрыта, но не заперта...»
...
Иногда вы просыпаетесь от криков.
