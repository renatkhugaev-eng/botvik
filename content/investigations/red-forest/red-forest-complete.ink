...
// ═══════════════════════════════════════════════════════════════════════════
// НОВАЯ ЛОКАЦИЯ: Квартира Зориных (требует высокое доверие Тани)
// ═══════════════════════════════════════════════════════════════════════════
* { actions_today < 3 && trust_tanya >= 50 && (MetCharacters ? tanya) && not zorin_apt_searched } [К Тане — попросить показать квартиру отца]
