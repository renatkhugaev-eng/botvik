...
LIST CluesE = klava_testimony, fyodor_map, gromov_confession, vera_research, old_photos, zorin_warning_letters, zorin_night_photos
...
{ CluesE ? fyodor_map || CluesE ? vera_research || CluesE ? gromov_confession || CluesE ? zorin_warning_letters || CluesE ? zorin_night_photos:
    ...
    { CluesE ? zorin_warning_letters: • ✉️ Письма Зорину — анонимные предупреждения (А.Ч., Г., шахта) }
...
// ═══════════════════════════════════════════════════════════════════════════════
// ЖУРНАЛ СЛЕДОВАТЕЛЯ — доступен из любой точки
// ═══════════════════════════════════════════════════════════════════════════════
+ [📋 Открыть журнал следователя]
    ~ journal_return_point = 1
    -> investigator_journal
