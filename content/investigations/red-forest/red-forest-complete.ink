...
// ═══ ДРУГИЕ ПОБОЧНЫЕ КВЕСТЫ (заглушки) ═══
{ active_sidequests ? sq_dogs_started || active_sidequests ? sq_dogs_solved:
    🐕 ПРОПАВШИЕ СОБАКИ:
    { active_sidequests ? sq_dogs_started: В процессе }
    { active_sidequests ? sq_dogs_solved: ✅ Завершено }
}
...
// ═══ ПУСТО ═══
{ not (active_sidequests ? sq_letters_started) && not (active_sidequests ? sq_letters_trusted) && not (active_sidequests ? sq_letters_ignored) && not (active_sidequests ? sq_letters_solved) && not interlude_nightmare_1_played:
...
// ═══════════════════════════════════════════════════════════════════════════════
// РАЗВИЛКА: Финал сейчас или продолжить расследование?
// ═══════════════════════════════════════════════════════════════════════════════

Полнолуние — сегодня ночью. Ритуал состоится. # style:dramatic # intensity:high
...
Следующее полнолуние — через десять дней. Культ будет ждать. Они всегда ждали. # style:thought # intensity:medium

У вас есть выбор. # style:dramatic

* [В Красный лес — пора заканчивать]
    # style:dramatic # intensity:high
    
    Нет. Хватит. # style:thought # intensity:high
    
    Сегодня — последний день. Сегодня — всё решится. # style:dramatic # intensity:high
    
    ~ advance_day()
    -> episode5_intro

* [Продолжить расследование (дни 6-15)]
    # style:discovery
    ...
    Полнолуние будет... но не сегодня. Следующее — через десять дней. # style:important
    
    Десять дней. Достаточно, чтобы узнать всю правду. # style:dramatic
    
    Вы возвращаетесь в город. # style:action
