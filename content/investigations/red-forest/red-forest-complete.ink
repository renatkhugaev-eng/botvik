...
За окном автобуса — лес. Чёрные сосны стоят плотной стеной, как часовые. Их кроны покачиваются на ветру, хотя внизу — полный штиль. # style:atmosphere

Странно. # style:dramatic
...
За забором — город. Пятиэтажки, дымящие трубы завода, площадь с памятником. Всё серое, размытое в снежной пелене. # style:atmosphere
...
Вы ждёте. Минута. Две. Три. # style:dramatic

Снег забивается за воротник. Ноги начинают неметь. Автобус за спиной — уезжает, не дождавшись. Водитель даже не посигналил на прощание. # style:atmosphere

Вы остались одни. # style:dramatic

Наконец — скрип двери КПП. Выходит офицер. Старший лейтенант, судя по погонам. Лицо — серое, усталое. Под глазами — тёмные круги. Он выглядит так, словно не спал неделю. # style:thought
...
* [Показать власть — потребовать уважения]
    ...
    Офицер открывает рот, чтобы возразить, но что-то в вашем взгляде останавливает его. # style:thought
    
    — Как скажете, товарищ следователь. # speaker:officer
    
    Внутри КПП — тепло и накурено. На стене — портрет Генсека, календарь с видами Крыма, расписание дежурств. # style:atmosphere
    
    Вы замечаете доску объявлений. "ВНИМАНИЕ! При обнаружении посторонних лиц в районе Красного леса — НЕМЕДЛЕННО сообщать дежурному!" # style:important
    
    Красный лес. Интересно. # style:thought
    
    -> ep1_kpp_inside

* [Осмотреться — изучить территорию]
    Вы делаете вид, что идёте к машине, но замедляете шаг. Оглядываетесь. # style:action
    
    За КПП — ещё одна вышка. На ней — часовой с биноклем. Смотрит не на дорогу — на лес. # style:thought
    
    У забора — следы. Странные следы. Не человеческие, не звериные. Что-то среднее. # style:important
...
Вы садитесь в машину. Молчите. Наблюдаете. # style:action

Офицер ведёт "УАЗик" по разбитой дороге. Его глаза — в зеркале заднего вида — несколько раз ловят ваш взгляд. Он нервничает всё больше. # style:thought
...
* [Молчать дальше]
    ...
    Молчание продолжается. Вы узнаёте больше из этого молчания, чем из любых слов. # style:thought
    
    Офицер боится. Не вас — чего-то другого. # style:important
...
* [Спросить про "Красный лес"]
    ...
    Он явно врёт. Или не говорит всего. # style:thought
...
* [Надавить — "Вы что-то скрываете"]
    ...
    Интересно. Начальник милиции — нервный, скрытный, уезжает по ночам. Классический профиль человека с секретом. Или... виновного? # style:important
...
Вы вспоминаете учебники криминалистики. Многие промышленные яды могут вызывать галлюцинации, паранойю, потерю памяти. Свинец, ртуть, некоторые органические соединения... # style:thought

Может, "странности" этого города — просто результат хронического отравления? Это объяснило бы многое. # style:thought

~ boost_theory(1, 5)

"УАЗик" подпрыгивает на выбоинах. Офицер за рулём молчит. Его пальцы — белые от напряжения — сжимают руль. # style:thought

Потом — жилые кварталы. Пятиэтажки-хрущёвки, одинаковые, как коробки. Серые стены, узкие окна, бельё на балконах. Дворы — пустые. Ни детей, ни стариков на лавочках. # style:atmosphere

Одиннадцать утра буднего дня. Где все? # style:thought

Вы замечаете людей — редких прохожих, спешащих по своим делам. Но они... странные. Идут быстро, опустив головы. Не разговаривают. Не смотрят друг на друга. # style:atmosphere
...
Всё как везде. Типичный советский городок. # style:thought

И всё — не так. # style:dramatic
...
"УАЗик" срывается с места так, словно за ним гонятся. # style:thought

Вы остаётесь один. Перед серым зданием. Под серым небом. В сером городе. # style:atmosphere

Ветер несёт снежную крупу. Где-то вдалеке — гудок завода. # style:atmosphere
...
* [Войти в отдел милиции]
    ...
    Внутри — запах канцелярии: чернила, бумага, застоявшийся сигаретный дым. И что-то ещё — еле уловимый запах страха. # style:atmosphere
    
    За стойкой дежурного — пусто. # style:thought
...
Коридор — длинный, тёмный, с облупившимися стенами. Лампы под потолком мигают, как в фильме ужасов. Двери по обе стороны — закрыты. За ними — тишина. # style:atmosphere

Кабинет начальника — в конце коридора. Табличка на двери: "Майор С.П. Громов. Начальник ГОВД".

Буквы — золотые на чёрном фоне. Единственная ухоженная вещь в этом здании. # style:thought
...
Громов смотрит. Оценивает. Вы делаете то же самое. # style:action

Этот человек — не дурак. Это первое, что вы понимаете. Несмотря на всё — на водку, на затхлый кабинет, на провинциальную глушь — он не дурак. # style:thought

И он — боится. Это второе. # style:important
...
* [Расскажите о муже подробнее]
    ...
    — Тринадцать лет счастья. А потом... этот проклятый завод. Этот проклятый проект. # speaker:klava
...
— А потом — утром — я проснулась, а он... лежит рядом. Холодный. С улыбкой на лице. С такой... счастливой улыбкой. # speaker:klava
...
* [А дети? У вас были дети?]
    ...
    — Был. — Её голос — еле слышный. — Сын. Петенька. # speaker:klava
