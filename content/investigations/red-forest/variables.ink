...
// ═══════════════════════════════════════════════════════════════════════════════
// Этот файл устарел. Все переменные объявлены в:
// → red-forest-complete.ink
//
// Новая архитектура использует LIST вместо VAR булевых флагов.
// ═══════════════════════════════════════════════════════════════════════════════
// КРАСНЫЙ ЛЕС — Общие переменные и функции (DEPRECATED)
// ═══════════════════════════════════════════════════════════════════════════════
