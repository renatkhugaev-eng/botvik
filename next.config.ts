          ...
          // Content Security Policy
          {
            ...
            value: [
              ...
              process.env.NODE_ENV === 'production'
                ? "script-src 'self' 'unsafe-inline' https://telegram.org https://*.telegram.org https://*.posthog.com https://*.sentry.io https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net"
                : "script-src 'self' 'unsafe-inline' 'unsafe-eval' https://telegram.org https://*.telegram.org https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net",
              ...
              "connect-src 'self' https://api.telegram.org https://*.telegram.org https://*.posthog.com https://*.sentry.io https://*.liveblocks.io wss://*.liveblocks.io https://*.upstash.io https://api-maps.yandex.ru https://*.yandex.ru https://*.yandex.net",
