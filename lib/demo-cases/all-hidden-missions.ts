...
// СГЕНЕРИРОВАНО АВТОМАТИЧЕСКИ с реальными panoId
// ═══════════════════════════════════════════════════════════════════════════

const TOKYO_CLUES: HiddenClue[] = [
  {
    id: "yakuza_clue_0_WuFobbns",
    panoId: "WuFobbnsRI-2cedm-2SQ4Q", // Реальный panoId, 6 шагов от старта
    revealHeading: 345.13,
    coneDegrees: 26,
    dwellTime: 2.4,
  ...
  {
    id: "yakuza_clue_1_-oPDOyqj",
    panoId: "-oPDOyqjYjSLoTRV2lZr4Q", // Реальный panoId, 12 шагов от старта
    revealHeading: 273.02,
    coneDegrees: 18,
    dwellTime: 3.2,
    name: "Burner phone",
    icon: "📱",
  ...
  },
  {
    ...
    panoId: "9exqkmRRREmpcpKkkJCb8Q", // Реальный panoId, 20 шагов от старта
    revealHeading: 92.49,
    coneDegrees: 14,
    dwellTime: 3.6,
    name: "Дорогие часы",
    icon: "⌚",
    storyContext: "Остановились в 22:47. На задней крышке: 'За правду — К.Т.'",
    xpReward: 88,
    hintText: "Золотой блеск в щели...",
    scannerHint: "Обнаружен объект типа \"Часы\".",
  },
  {
    id: "yakuza_clue_3_S4zXbGlp",
    panoId: "S4zXbGlp37QTh24yf1oYVg", // Реальный panoId, 31 шаг от старта
    revealHeading: 357.81,
    coneDegrees: 12,
    dwellTime: 4.0,
    name: "Следы крови",
    icon: "🩸",
    ...
    xpReward: 126,
    hintText: "Что-то тёмное на стене...",
    scannerHint: "Обнаружен объект типа \"Кровь\".",
  },
  {
    id: "yakuza_clue_4_JJ3zvGsw",
    panoId: "JJ3zvGswEbCHtKUB7svAuw", // Реальный panoId, 35 шагов от старта
    revealHeading: 258.55,
    coneDegrees: 12,
    dwellTime: 4.0,
    ...
    xpReward: 63,
    hintText: "Что-то яркое на стене...",
...
⚠️ ОСТОРОЖНО: Якудза следит за местом.`,
  ...
  startPanoId: "5DbydaNVaYEKOP1i2OWVrw", // Реальный стартовый panoId
  startHeading: 0,
