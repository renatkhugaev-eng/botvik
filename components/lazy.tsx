...
// Placeholder для ежедневных заданий
function DailyChallengesPlaceholder() {
  return (
 ...
 * Загружается на главной странице
 */
export const LazyDailyChallenges = dynamic(
  () => import("@/components/DailyChallenges").then((mod) => mod.DailyChallenges),
  {
    ssr: false,
    loading: DailyChallengesPlaceholder,
  }
);
