              ...
              {/* XP Progress to next level */}
                ...
                >
                  ...
                  <span className="text-white/50 flex items-center gap-1.5">
                    <img src="/icons/34.webp" alt="" className="h-5 w-5 object-contain" /> Уровень {xp.level}
                  </span>
                ...
                <div className="flex items-center justify-between">
                  <div>
                    <div className="flex items-center gap-2 mb-1">
                      <img src="/icons/7.webp" alt="" className="h-10 w-10 object-contain" />
...
style={{
      ...
      >
        {[
          { id: "stats" as const, label: "Статистика", icon: <img src="/icons/22.webp" alt="" className="h-5 w-5 object-contain" /> },
          { id: "history" as const, label: "Рекорды", icon: <img src="/icons/19.webp" alt="" className="h-6 w-6 object-contain" /> },
          { id: "friends" as const, label: "Друзья", icon: <img src="/icons/6.webp" alt="" className="h-6 w-6 object-contain" /> },
        ].map((tab) => (
          <motion.button
            key={tab.id}
            onClick={() => {
        ...
        {activeTab === "stats" ? (
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-3">
              {[
                { icon: <img src="/icons/56.webp" alt="" className="h-6 w-6 object-contain" />, label: "Игры", value: data.stats.totalQuizzesPlayed, color: "#6366f1" },
                { icon: <img src="/icons/31.webp" alt="" className="h-6 w-6 object-contain" />, label: "Попытки", value: data.stats.totalSessions, color: "#06b6d4" },
                { icon: <img src="/icons/51.webp" alt="" className="h-6 w-6 object-contain" />, label: "Верные", value: data.stats.totalCorrectAnswers, color: "#10b981" },
                { icon: <img src="/icons/22.webp" alt="" className="h-6 w-6 object-contain" />, label: "Точность", value: accuracy, suffix: "%", color: "#f59e0b" },
              ].map((stat, i) => (
                <motion.div
                  key={stat.label}
            ...
            >
              <div className="flex items-center gap-4">
                <div className="flex h-14 w-14 flex-shrink-0 items-center justify-center rounded-xl bg-gradient-to-br from-violet-500 to-purple-600 text-2xl shadow-lg">
                  {data.stats.totalQuizzesPlayed >= 10 ? <img src="/icons/51.webp" alt="" className="h-10 w-10 object-contain" /> : data.stats.totalQuizzesPlayed >= 5 ? <img src="/icons/19.webp" alt="" className="h-10 w-10 object-contain" /> : <img src="/icons/22.webp" alt="" className="h-10 w-10 object-contain" />}
                </div>
              ...
              >
                ...
                <div className="bg-gradient-to-r from-[#1a1a2e] to-[#2d1f3d] p-4">
                  <div className="flex items-center gap-2">
                    <img src="/icons/31.webp" alt="" className="h-6 w-6 object-contain" />
          ...
          >
            <div className="mb-5 flex items-center justify-between">
              <div className="flex items-center gap-2">
                <img src="/icons/54.webp" alt="" className="h-10 w-10 object-contain" />
            ...
            {data.stats.bestScoreByQuiz.length === 0 ? (
              <div className="flex flex-col items-center py-12">
                <img src="/icons/22.webp" alt="" className="h-20 w-20 object-contain animate-bounce" />
              ...
              <>
                ...
                {friends.length === 0 && incomingRequests.length === 0 && outgoingRequests.length === 0 ? (
                  <div className="rounded-2xl bg-white p-8 shadow-lg shadow-black/5 text-center">
                    <img src="/icons/6.webp" alt="" className="h-16 w-16 mx-auto mb-4 object-contain" />
                            ...
                            <div className="flex items-center justify-between rounded-xl bg-slate-50 p-3">
                              <div className="text-center flex-1">
                                <div className="flex items-center justify-center gap-1">
                                  <img src="/icons/7.webp" alt="" className="h-9 w-9 object-contain" />
            ...
            >
              <div className="text-center mb-6">
                <div className="mx-auto mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-gradient-to-br from-violet-500 to-indigo-600">
                  <img src="/icons/6.webp" alt="" className="h-10 w-10 object-contain" />
                </div>
      ...
      >
        ...
        <div className="space-y-3">
          <NotificationToggle
            ...
            icon={<img src="/icons/38.webp" alt="" className="h-7 w-7 object-contain" />}
          ...
          <NotificationToggle
            ...
            icon={<img src="/icons/11.webp" alt="" className="h-7 w-7 object-contain" />}
          ...
          <NotificationToggle
            ...
            icon={<img src="/icons/30.webp" alt="" className="h-7 w-7 object-contain" />}
          ...
          <NotificationToggle
            ...
            icon={<img src="/icons/6.webp" alt="" className="h-7 w-7 object-contain" />}
